...
F_1_vec = F_1*[0, 1, 0]';
F_2_vec = F_2*[0, 1, 0]';
F_3_vec = F_3*[0, sin(alpha), cos(alpha)]';
F_4_vec = F_4*[0, sin(alpha), cos(alpha)]';
...
equations = [eq1, eq2, eq3, eq4, eq5, eq6, eq7, eq8, eq9, eq10, eq11,  eq13, eq14, eq16, eq17];
equations = [eq2, eq3, eq4];
...
equations = subs(equations, [F_1, F_2, F_3, F_4], [ky_1*N_1, ky_2*N_2, kz_3*N_3, kz_4*N_4]);
...
equations = subs(equations, [ky_1, ky_2], [ky, ky]);
equations = subs(equations, [kz_3, kz_4], [kz, kz]);
